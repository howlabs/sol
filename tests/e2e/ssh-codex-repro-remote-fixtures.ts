...
await write('If Sol leaves wide gray rectangles here, they are stale remote-PTY render artifacts.\\r\\n')
...
await write('Tip: deterministic fixture for Sol SSH Codex display artifacts.\\r\\n\\r\\n')
