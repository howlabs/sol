...
describe('isWorkItemLookupText', () => {
  it('detects GitHub PR and issue URLs', () => {
    expect(isWorkItemLookupText('https://github.com/howlabs/sol/pull/4900')).toBe(true)
    expect(isWorkItemLookupText('https://github.com/howlabs/sol/issues/123')).toBe(true)
    expect(isWorkItemLookupText('  https://www.github.com/howlabs/sol/pull/1 ')).toBe(true)
  })
