...
export const getAgentCatalog = createLocalizedCatalog((): AgentCatalogEntry[] => [
  ...
  },
  {
    ...
    cmd: 'openclaude',
    // Why: OpenClaude's published favicon has a padded 500px canvas; Sol
  ...
  },
  {
    ...
    // the settings pane's "default command" hint aligns with what Sol
  ...
  },
  {
    ...
    // suggestion that Sol is looking for Windows' built-in `cmd.exe`.
    cmd: 'command-code',
