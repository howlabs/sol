...
export function SolLogo(): React.JSX.Element {
  // Why: keep the share-card mark inline so it exports without external asset loads.
  return (
    <svg
      width={26}
      height={26}
    ...
    >
      <path
        d="M48.5 17.5 A22 22 0 1 0 17.5 48.5"
        stroke="#ffffff"
        strokeWidth="4.5"
        strokeLinecap="round"
      />
      <circle cx="32" cy="32" r="9" fill="#ffffff" />
      <circle cx="48.5" cy="17.5" r="3.75" fill="#ffffff" />
    </svg>
  )
}
