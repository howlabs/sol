        ...
        >
          <SettingsSwitchRow
            ...
            description={translate(
              ...
              'Stops idle background agent terminals after the configured idle window and resumes supported sessions when you open them again. Agent sleep preserves launch options for agents started by Sol. Manually started agents may resume with your current Sol defaults. Experimental while we tune the safety model.'
            )}
          ...
          {agentHibernationEnabled ? (
            <NumberField
              ...
              description={translate(
                ...
                'How many idle minutes a completed background agent must wait before Sol can sleep it.'
              )}
