...
describe('AgentsPane', () => {
  ...
  it('renders the keep-awake toggle in session settings content', () => {
    ...
    expect(markup).toContain(
      'Keeps this computer and display awake while agents are working. Sol also asks this device to stay awake when the lid is closed, subject to its power policy.'
    )
