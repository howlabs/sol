...
const INSTALL_COMMAND = 'npx skills add https://github.com/howlabs/sol --skill orca-cli --global'
...
function panelProps(
  ...
  return {
    title: 'CLI skill',
    description: 'Enables agents to use Sol workflows.',
...
describe('AgentSkillSetupPanel', () => {
  ...
  it('keeps update copy until the installed panel checks CLI prerequisites', () => {
    const html = renderPanel({
      ...
      preInstallNotice: 'Install the Sol CLI before running agent skill setup.'
    })
