...
export const getNotificationsPaneSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Master switch for Sol desktop notifications.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Avoid notifying when Sol is focused on the active worktree.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose the built-in, system, or local audio file Sol plays for desktop notifications.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
