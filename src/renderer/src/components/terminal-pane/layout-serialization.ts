...
// "attach to a still-running TUI" — but Sol restores scrollback against a
...
// font gives Sol a known-good fallback even on clean systems, while the
...
const FALLBACK_FONTS = [
  ...
  'Sol Nerd Font Symbols', // bundled PUA fallback for OMP/Powerline glyphs
