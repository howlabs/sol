...
export default function SparseCheckoutPresetSelect({
  ...
  return (
    ...
    >
      ...
      <PopoverContent
        align="start"
        className="popover-scroll-content max-h-[min(var(--available-height, var(--radix-popover-content-available-height)),24rem)] w-[var(--anchor-width, var(--radix-popover-trigger-width))] max-w-[calc(100vw-2rem)] overflow-y-auto p-0 scrollbar-sleek"
