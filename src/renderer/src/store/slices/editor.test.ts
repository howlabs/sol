...
describe('createEditorSlice activateMarkdownLink', () => {
  ...
  it('opens in-worktree file links in Sol', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs inside the worktree in Sol', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs outside the worktree in Sol after authorizing them', async () => {
    const store = createEditorStore()
