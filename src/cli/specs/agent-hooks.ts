...
export const AGENT_HOOK_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'Show whether Sol-managed agent status hooks are enabled',
  ...
  },
  {
    ...
    summary: 'Disable Sol-managed agent status hooks and remove local hook entries',
  ...
  {
    path: ['agent', 'hooks', 'on'],
    summary: 'Enable Sol-managed agent status hooks',
