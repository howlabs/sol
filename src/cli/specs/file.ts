...
export const FILE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['file', 'open'],
    summary: 'Open a workspace file in the Sol editor',
    usage: 'orca file open <path> [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'path', 'worktree'],
    positionalArgs: ['path'],
    notes: [
      'The path is relative to the selected worktree. When --worktree is omitted, local CLI calls infer the current Sol worktree from cwd.'
    ],
    examples: [
  ...
  {
    path: ['file', 'diff'],
    summary: 'Open a workspace file diff in the Sol editor',
