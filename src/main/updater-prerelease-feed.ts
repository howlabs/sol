...
const ATOM_FEED_URL = 'https://github.com/howlabs/sol/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/howlabs/sol/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/howlabs\/sol\/releases\/tag\/([^"]+)"/g
