...
describe('getPRForBranch', () => {
      ...
      stdout: JSON.stringify([
        {
          ...
          title: 'Fork PR',
          state: 'open',
          html_url: 'https://github.com/howlabs/sol/pull/1738',
          updated_at: '2026-03-28T00:00:00Z',
          draft: false,
    ...
    ghExecFileAsyncMock
        ...
        stdout: JSON.stringify([
          {
            ...
            html_url: 'https://github.com/howlabs/sol/pull/5511',
      ...
      .mockResolvedValueOnce({
        stdout: JSON.stringify({
          ...
          title: 'Merged branch PR',
          state: 'MERGED',
          url: 'https://github.com/howlabs/sol/pull/5511',
          statusCheckRollup: [],
        ...
        stdout: JSON.stringify([
          {
            ...
            state: 'open',
            html_url: 'https://github.com/howlabs/sol/pull/42',
            updated_at: '2026-03-28T00:00:00Z',
            draft: false,
            mergeable: true,
            base: { ref: 'main', sha: 'base-oid' },
    ...
    ghExecFileAsyncMock
        ...
        stdout: JSON.stringify([
          {
            ...
            state: 'open',
            html_url: 'https://github.com/howlabs/sol/pull/78',
            updated_at: '2026-03-28T00:00:00Z',
            draft: false,
            mergeable: true,
            base: { ref: 'main', sha: 'base-oid' },
      ...
      .mockResolvedValueOnce({
        stdout: JSON.stringify({
          ...
          state: 'OPEN',
          url: 'https://github.com/howlabs/sol/pull/78',
          statusCheckRollup: [],
          updatedAt: '2026-03-28T00:00:00Z',
          isDraft: false,
          mergeable: 'MERGEABLE',
    ...
    ghExecFileAsyncMock
        ...
        stdout: JSON.stringify([
          {
            ...
            state: 'open',
            html_url: 'https://github.com/howlabs/sol/pull/6433',
      ...
      .mockResolvedValueOnce({
        stdout: JSON.stringify({
          ...
          title: 'Recover Windows worktree deletes from long paths',
          state: 'OPEN',
          url: 'https://github.com/howlabs/sol/pull/6433',
          statusCheckRollup: [],
        ...
        stdout: JSON.stringify([
          {
            ...
            state: 'open',
            html_url: 'https://github.com/howlabs/sol/pull/79',
            updated_at: '2026-03-28T00:00:00Z',
            draft: false,
            mergeable: true,
            base: { ref: 'main', sha: 'base-oid' },
      ...
      stdout: JSON.stringify({
        head: {
          ...
          repo: {
            ...
            name: 'orca',
            clone_url: 'https://github.com/howlabs/sol.git',
  ...
  it('does not treat a same-repository upstream remote as a fork', async () => {
    getOwnerRepoMock.mockResolvedValueOnce({ owner: 'StablyAI', repo: 'Sol' })
    getOwnerRepoForRemoteMock.mockResolvedValueOnce({ owner: 'stablyai', repo: 'orca' })
    ghExecFileAsyncMock.mockResolvedValueOnce({
        ...
        stdout: JSON.stringify([
          {
            ...
            body: 'top-level',
            created_at: '2026-04-01T00:00:00Z',
            html_url: 'https://github.com/howlabs/sol/pull/7#issuecomment-10'
          }
        ])
      })
      .mockResolvedValueOnce({ stdout: '[]' })
    ...
    ghExecFileAsyncMock
      .mockResolvedValueOnce({
        stdout: JSON.stringify({
          ...
          title: 'PR',
          state: 'OPEN',
          url: 'https://github.com/howlabs/sol/pull/7',
          statusCheckRollup: [],
    ...
    ghExecFileAsyncMock.mockImplementation(async (args) => {
      ...
      return {
        stdout: JSON.stringify({
          ...
          title: 'PR',
          state: 'OPEN',
          url: `https://github.com/howlabs/sol/pull/${prViewCount}`,
          statusCheckRollup: [],
          updatedAt: '2026-04-01T00:00:00Z',
          isDraft: false,
          mergeable: 'MERGEABLE',
