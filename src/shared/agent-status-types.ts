...
// These types define the normalized status that Sol receives from Claude,
...
export type AgentStateHistoryEntry = {
   ...
   *  (for example Claude Code `is_interrupt`) or Sol's guarded interrupt
...
export type AgentStatusEntry = {
   ...
   *  inferred by Sol's guarded interrupt fallback.
   ...
   *  Used only for exact CLI resume; Sol terminal ids are not agent-session ids. */
