// Per-step copy for the workbench tile in the Explore Sol modal. Mirrors
...
export const WORKBENCH_STEPS: readonly WorkbenchStep[] = [
  ...
  },
  {
    ...
    name: 'Editor',
    subtitle: 'Editor',
    description: 'Use our Notion-style markdown editor to write notes without leaving Sol.'
  },
  {
    id: 'browser',
    name: 'Browser',
    subtitle: 'Browser',
    description:
      "Run your app in Sol's browser, send selected UI elements to agents, and let your agents interact with your webpage."
  }
] as const
