...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use Sol's browser",
    subtitle: "Use Sol's browser",
    description:
      'Browse your web app without leaving Sol. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable Sol CLI',
    subtitle: 'Enable Sol CLI',
    description:
      'Register the Sol shell command and install agent skills for browser and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into Sol so you can start agent work without hunting for folders.'
  }
] as const
