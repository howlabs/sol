...
//     keyword land right after a path separator. Sol is a cross-platform
...
// across the entire turn — it carries zero working/idle information. Sol
...
export function detectAgentStatusFromTitle(title: string): AgentStatus | null {
  ...
  // action required") is either a Sol-synthesized working/permission title
