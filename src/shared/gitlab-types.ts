...
// target_type narrows to the four shapes Sol renders meaningfully —
...
// tab so users can see which job failed and where without leaving Sol.
...
export type GitLabWorkItemDetails = {
   ...
   *  picker) — main-process doesn't know Sol's Repo.id. */
