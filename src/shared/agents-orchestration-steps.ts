// Per-step copy for the agents-orchestration tile in the Explore Sol modal.
...
export const AGENTS_STEPS: readonly AgentsStep[] = [
  ...
  },
  {
    ...
    description: 'Enable agents to manage and coordinate Sol workspaces to execute larger tasks.'
  },
  {
    id: 'usage',
    name: 'Usage',
