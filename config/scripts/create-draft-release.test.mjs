...
describe('createDraftRelease', () => {
  it('creates a draft release with bounded generated notes', async () => {
    ...
    expect(fetchImpl).toHaveBeenNthCalledWith(
      1,
      'https://api.github.com/repos/howlabs/sol/releases?per_page=100&page=1',
      expect.any(Object)
    )
    expect(fetchImpl).toHaveBeenNthCalledWith(
      2,
      'https://api.github.com/repos/howlabs/sol/releases/generate-notes',
    ...
    expect(fetchImpl).toHaveBeenNthCalledWith(
      3,
      'https://api.github.com/repos/howlabs/sol/releases',
      expect.objectContaining({
        method: 'POST',
  ...
  it('paginates through every release page before choosing the previous release', async () => {
    ...
    expect(fetchImpl).toHaveBeenNthCalledWith(
      2,
      'https://api.github.com/repos/howlabs/sol/releases?per_page=100&page=2',
      expect.any(Object)
    )
