...
describe('check-styled-scrollbars', () => {
  it('reports renderer vertical scroll containers without a Sol scrollbar style', () => {
  ...
  it('does not accept nonexistent scrollbar classes as Sol scrollbar styles', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports inline vertical overflow without a Sol scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('accepts inline vertical overflow with a stable Sol scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports logical inline style spreads without a Sol scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
